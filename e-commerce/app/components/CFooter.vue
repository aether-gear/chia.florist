  ...
  <footer class="bg-[#1b4332] text-white py-8 px-4 md:px-12 w-full">
    <div class="w-full grid grid-cols-1 md:grid-cols-3 items-center gap-8">
      ...
      <div class="flex gap-12 justify-start">
        ...
        <div>
          <h4 class="text-base font-bold mb-3 opacity-90">Social</h4>
          <ul class="space-y-2 font-medium text-sm md:text-base">
      ...
      <div class="flex justify-center items-center">
        <img src="/images/footer.png" class="w-40 h-auto object-contain" alt="Logo" />
      </div>
      ...
      <div class="flex flex-col items-end text-right">
        ...
        <p class="max-w-[280px] text-xs font-medium leading-relaxed opacity-90">
    ...
    <div class="w-full mt-8 text-center text-xs font-medium opacity-80 border-t border-white/10 pt-4">
