...
<template>
  <div class="w-full bg-white text-black font-sans">
    ...
    <section class="max-w-7xl mx-auto px-8 py-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
      <div>
        <h2 class="text-3xl md:text-4xl font-bold text-[#1b4332] leading-tight max-w-sm">
    ...
    <section class="max-w-7xl mx-auto px-8 pb-24 grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="bg-white border border-gray-100 p-8 rounded-lg shadow-sm hover:shadow-md transition">
        <div class="text-[#1b4332] mb-6">
      ...
      <div class="bg-[#1b4332] text-white p-8 rounded-lg shadow-md transition transform hover:scale-105">
    ...
    <section class="max-w-7xl mx-auto px-8 py-20">
      <h2 class="text-3xl md:text-4xl font-bold text-center text-[#1b4332] mb-12">What We Offer To You</h2>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        
        <div v-for="(item, idx) in productOfferings" :key="idx" class="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition">
          <div class="h-64 relative bg-gray-50">
            <div v-if="item.name === 'Custom'" class="w-full h-full bg-[#1b4332] flex items-center justify-center">
    ...
    <section class="max-w-7xl mx-auto px-8 py-20">
      <h2 class="text-3xl md:text-4xl font-bold text-center text-[#1b4332] mb-12">Our Gallery View</h2>
    ...
    <section class="max-w-7xl mx-auto px-8 py-20">
      <h2 class="text-3xl md:text-4xl font-bold text-center text-[#1b4332] mb-12">What Do They Say About Us</h2>
