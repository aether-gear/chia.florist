...
// error.vue — Nuxt 3 global error page
// Rendered by Nuxt when a fatal/unhandled error occurs (SSR 500, unhandled createError, etc.)
...
<style>
/* Inline global styles — needed because the global CSS may not be loaded in error.vue context */
@import url('/fonts/Inter_18pt-Regular.ttf');
